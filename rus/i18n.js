...
const i18n = {
    ...
    "result-issues": {
       ...
       "result-a-label": {
        "en": ["Реакционный","Прогрессивный","Реформистский","Нейтральный","Консервативный","Традиционный","Реакционный"],
    ...
    "result-b-label": {
        "en": ["Плановая экономика","Интервенционизм","Регуляционизм","Нейтральный","Ограниченное регулирование","Свободный рынок","Невмешательство"],
    ...
    "result-c-label": {
        "en": ["Тоталитарный","Авторитарный","Государственный","Нейтральный","Демократический","Либертарианский","Анархистский"],
    ...
    "result-d-label": {
        "en": ["Релятивизм","Партикуляризм","Пацифизм","Нейтралитет","Дипломатический интервенционизм","Универсализм","Империализм"],
    ...
    "result-e-label": {
        "en": ["Теократия","Религиозный Авторитаризм","Религиозное влияние","Нейтралитет","Антиклерикализм","Светское государство","Атеизм"],
    ...
    "result-f-label": {
        "en": ["Трансгуманизм", "Акселерационизм","Про-Технология","Нейтралитет","Гуманизм","Замедление","Примитивизм"],
    ...
    "result-g-label": {
        "en": ["Идентитарный","Этнический националист","Расовый реалист","Нейтральный","Расовое равенство","Антирасизм","Расовый дальтонизм"],
